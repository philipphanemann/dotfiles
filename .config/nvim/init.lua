...
vim.keymap.set('v', '<C-c>', '"+y', { desc = 'yank into clipboard register' })
...
vim.keymap.set("n", "<leader>sg", require('telescope').extensions.live_grep_args.live_grep_args, { desc = '[S]earch by Rip[G]rep with args' })
