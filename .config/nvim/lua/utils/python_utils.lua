...
function M.PythonFileImportStatement(variable)
	...
	-- Create the import statement with specific variable or * if not provided
	local import_what = variable or "*"
	local import_statement = "from " .. module_path .. " import " .. import_what
